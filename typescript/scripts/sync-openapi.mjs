...
if (
  ...
  throw new Error(`${source} does not expose the expected executable 51-intent, query-language 1.12, provider-operation, and canonical exposure contract`);
}
