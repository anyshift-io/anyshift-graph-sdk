...
if (
  ...
  || !["1.17-sdk.2", "1.23"].includes(queryLanguage?.version)
  ...
  throw new Error(`${source} does not expose the expected executable query-language 1.17-sdk.2 or 1.23 active incident, correlations, operational-response identity candidates, cloud-event, canonical exposure, exposure platform, and monitor scope-target contract`);
}
